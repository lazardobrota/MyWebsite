...
export default function Main() {
  return (
    <div id="main" className="flex flex-col lg:flex-row-reverse gap-8 lg:gap-36 place-items-center relative pt-16 pb-32 lg:pt-44 lg:pb-96 px-5 lg:px-36">
      ...
      <div className="flex flex-col gap-8 max-lg:place-items-center">
        <p className="font-bold text-4xl text-white lg:text-h1">
          Hellooooo;
        </p>
        <p className="max-lg:text-center text-white lg:text-xl">
