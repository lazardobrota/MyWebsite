...
export default function Main({ ref }: RefInfo) {
  ...
  return (
    <div ref={ref as LegacyRef<HTMLDivElement>} id="main" className=" flex flex-row justify-center relative">
      <BackgroundTop preserveAspectRatio="none" className="size-full absolute top-0 left-0 -z-10" />
      <div className="flex flex-col xl:flex-row-reverse gap-8 xl:gap-36 place-items-center pt-16 pb-32 xl:pt-44 xl:pb-96 px-5 xl:px-36 lg:max-w-custom">
      ...
      <div className="flex flex-col gap-8 max-xl:place-items-center">
        ...
        <p className="max-xl:text-center text-white xl:text-xl">
          ...
          While I enjoy coding in Java, I don&apos;t drink coffee.
        </p>
      </div>
      </div>
    </div>
