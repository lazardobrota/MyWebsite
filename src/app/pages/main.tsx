  ...
  return (
    <div ref={ref as LegacyRef<HTMLDivElement>} id="main" className="flex flex-col xl:flex-row-reverse gap-8 xl:gap-36 place-items-center relative pt-16 pb-32 xl:pt-44 xl:pb-96 px-5 xl:px-36">
      ...
      <div className="flex flex-col gap-8 max-xl:place-items-center">
        ...
        My name is Lazar Dobrota, and I am a Software Engineer, building a wide range of backend projects and designing custom frontend interfaces for some of them. I focus on clean architecture, scalability and even though I like Java I don’t drink coffee.
          {/* My name is Lazar Dobrota, and I am a Software Engineer, building a wide range of backend projects and designing custom frontend interfaces for some of them. I'm also passionate about gaming and game development. */}
        </p>
      </div>
    </div>
  )
