...
export default function AboutMe({ref}: RefInfo) {
  ...
  return (
    <div ref={ref as LegacyRef<HTMLDivElement>} id="about-me" className="flex flex-col gap-20 lg:gap-28 place-content-center py-32 lg:py-44 relative p-5 lg:px-36">
