...
export default function AboutMe({ ref }: RefInfo) {
  ...
  return (
    <div ref={ref as LegacyRef<HTMLDivElement>} id="about-me" className="flex flex-row justify-center relative">
      <BackgroundMiddle preserveAspectRatio="none" className="size-full top-0 left-0 absolute -z-10" />
      <div className="flex flex-col gap-20 lg:gap-28 items-center py-32 lg:py-44 p-5 lg:px-36 lg:max-w-custom">
